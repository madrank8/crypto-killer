 ...
 *
 * The writer prompts (review-pipeline corePrompts + review-prompts
 * contentWriterPrompt) require a `category` field on each red flag from
 * the 8-item taxonomy: celebrity_abuse, geo_spread, velocity, regulatory,
 * withdrawal, social_proof, funnel_mechanics, financial_promises.
 * Two flags with the same category indicate redundant coverage — the
 * Floventra bug where 3 of 8 flags were celebrity-related variants of the
 * same phenomenon. (Field was missing from the prompts until the
 * 2026-07-05 audit — this validator was inert before then.)
 *
