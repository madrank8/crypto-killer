  ...
  return [
    {
      ...
      evidence: celebs > 0 ? `${celebs} real ${celebs === 1 ? 'person' : 'people'} impersonated in ads` : 'no celebrity impersonation detected',
    },
    {
      key: 'geo_spread',
      label: 'Geographic Spread',
      score: band(geos, [[0, 5], [1, 25], [2, 40], [5, 60], [10, 80], [20, 95]]),
      evidence: `ads detected in ${geos} ${geos === 1 ? 'country' : 'countries'}`,
    },
    {
      key: 'ad_velocity',
      label: 'Campaign Velocity',
      score: band(velocity, [[0, 10], [1, 40], [5, 60], [15, 80], [30, 95]]),
      evidence: `${velocity} new creatives in the last 7 days`,
    },
    {
      key: 'campaign_scale',
      label: 'Campaign Scale',
      score: band(creatives, [[0, 5], [1, 25], [10, 40], [50, 60], [200, 80], [1000, 95]]),
      evidence: `${creatives.toLocaleString()} ad creatives catalogued`,
    },
    {
      key: 'longevity',
      label: 'Operation Longevity',
      score: band(days, [[0, 10], [7, 30], [30, 50], [90, 70], [180, 85], [365, 95]]),
      evidence: `${days} days between first and last detected activity`,
    },
  ]
}
