...
function buildContentBrief(topic, { parentTopic } = {}) {
  ...
  if (nonEmpty(t.secondary_keywords)) targeting.secondary_keywords = t.secondary_keywords
  ...
  if (nonEmpty(t.paa_questions)) brief.heading_seeds = t.paa_questions
  ...
  // ── Internal links ──────────────────────────────────────────────────────────
  if (nonEmpty(t.internal_links_to)) brief.internal_link_targets = t.internal_links_to
