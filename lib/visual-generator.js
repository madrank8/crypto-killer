...
/**
 * Generate an image using Google Imagen 4.0 (primary), DALL-E 3 (fallback),
...
async function generateImage(description, altText) {
  // ─── PRIMARY: Google Imagen 4.0 (~5-8s per image) ───
  if (GOOGLE_AI_API_KEY) {
    try {
      ...
      console.error(`[Visual] Imagen FAILED: ${imagenErr.message} — falling back to DALL-E`)
    }
  }
