  ...
  return {
    ...
    '@graph': [
      ...
      // ── Organization Entity (Foundation + Authority Layer) ──
      {
        ...
        name: 'Crypto Killer',
        url: siteUrl,
        description: 'Scam intelligence platform powered by our proprietary CryptoKiller ad surveillance technology. Analyzes fraudulent advertising campaigns to protect consumers from cryptocurrency investment scams.',
        knowsAbout: [
      ...
      // topic. Falls back to a generic crypto-fraud expertise list.
      {
        ...
        hasCredential: {
          ...
          description: `CryptoKiller ad surveillance platform operators with intelligence on 500+ scam brands.`,
        },
      },
