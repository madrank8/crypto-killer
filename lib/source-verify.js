...
const HEAD_403_OK = new Set([
  ...
  // UK Action Fraud / police.uk reporting portal blocks automated HEAD
  // while remaining the canonical public contact page for victims.
  'actionfraud.police.uk', 'www.actionfraud.police.uk',
])
