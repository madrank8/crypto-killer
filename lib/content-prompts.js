 ...
 * Updated to seo-blog-generator v4.1 — full skill parity — Koray semantic planning layer.
 */
...
- [CHART NEEDED: description with alt text]
- [IMAGE NEEDED: description with alt text]
- [SCREENSHOT NEEDED: description with alt text]
- [DIAGRAM NEEDED: description with alt text]
First visual placeholder within 500 words. Distribute throughout.
...
Return JSON with this exact shape:
{
  ...
  "sections": [
    {
      "heading": "H2 heading — question format where natural",
      "micro_vector": "Specific sub-context this section maintains",
      "body": "120-260 words plain text. Opens with 40-60 word extractive answer. Declaration-first."
    }
  ],
  "not_for_you": "80-120 words. Named scenarios where this content does NOT apply. MUST include at least one line a competitor would never publish. Something specific enough to scare off a lead. Mandatory section. HARD FAIL if absent.",
  "faq": [
