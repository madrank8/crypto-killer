...
Return JSON with this exact shape:
{
  ...
  "author_bio": "1-2 sentence bio with credentials relevant to this topic. MUST NOT begin with the author's own name — the renderer prepends the name. Start with the credential or role (e.g., 'Financial-crime researcher with 8 years investigating crypto fraud...').",
