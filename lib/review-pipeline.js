...
- Every celebrity count in prose MUST be the token {{stat:celebrities_abused}} — never a hard-coded number (it drifts as rosters are deduped and re-scraped). This list is your source of truth for WHO; the token is HOW MANY.
