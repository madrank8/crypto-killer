 ...
 *   synced to v5.2 PARTIALLY on 2026-07-05: unified kill lists (W4b, via
 *   lib/content-lint ANTI_SLOP_PROMPT_BLOCK), AI disclosure Step 6.8 (W4c,
 *   deterministic via lib/ai-disclosure), archetype rotation Step 4 (W4d).
 *   Still missing from canon: Step 6.10 authorship-gate scoring, 6.11
 *   retrieval-arbitration. Do NOT claim "full parity" here again without
 *   diffing against ~/Documents/GitHub/ai-brain.)
...

{
  ...
  "hard_fail_checks": {
    ...
    "any_hard_fail": "BOOLEAN — TRUE if ANY hard-fail check above is triggered (item_reviewed not typed, unverified_claims_in_article > 0, not_for_you_block_present false, fabricated_source_or_stat, fake_or_unmarked_freshness, fabricated_reviews_or_testimonials, missing_risk_or_ftc_disclosure, or commodity_no_information_gain). This flag GATES PUBLICATION — be strict and honest; a true value blocks publish.",
