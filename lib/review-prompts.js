 ...
 * - Phase 5: Quality Auditor (GPT-4o — fresh perspective, v4.1 12-pass audit)
 */
...

{
  ...
  "summary": "2-3 sentences MAXIMUM, under 250 characters total. Card preview. First sentence: '{Brand} is a confirmed crypto scam with a {score}/100 threat score.' Second: one key stat. STRICT LIMIT: 250 characters.",
  "key_takeaways": ["5-6 bullet points. Each contains a specific number from intelligence data. Declaration-first."],
  "how_it_works": "EXACTLY 4 paragraphs separated by \\n\\n. Each 50-80 words. STAGE 1: Celebrity Impersonation & Ads. STAGE 2: The Funnel & Deposit. STAGE 3: Fake Profits & Manipulation. STAGE 4: The Withdrawal Trap. Each MUST cite specific numbers.",
...
Include functional visual placeholders (not decorative stock photos):
- [CHART NEEDED: comparison of ad creative volume over campaign duration]
- [IMAGE NEEDED: screenshot of typical fake celebrity endorsement ad]
- [SCREENSHOT NEEDED: platform registration page showing no regulatory info]
- [DIAGRAM NEEDED: scam funnel flowchart from ad click to deposit trap]
Include descriptive alt text. First visual placeholder within 500 words.
