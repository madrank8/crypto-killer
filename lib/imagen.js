...
// Default to the full (non-fast) Imagen 4 for better editorial quality.
// Override via env var IMAGEN_MODEL to pick a newer or different model
// (e.g. imagen-4.0-ultra-generate-001, or gemini-2.5-flash-image-preview)
