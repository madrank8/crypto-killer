 ...
 *
 * Comments pinned to seo-blog-generator v5.4 (Aug 2026). Kill-list sync landed
 * with v5.2. NOT ported from v5.4: Step 6.7b brief-fidelity-gate, Step 6.9c
...
const KILL_PHRASES = [
  ...
  // pinned to canon v5.4 comments (2026-08). Kill-list sync was v5.2 (2026-07-05):
  // was /let'?s dive in\b/ which failed to
